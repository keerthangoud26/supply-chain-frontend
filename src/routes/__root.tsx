...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "AI-powered supply chain intelligence: real-time logistics, predictive analytics, and anomaly detection for enterprise retail." },
      { property: "og:title", content: "Nexus Supply Chain AI" },
      { property: "og:description", content: "Enterprise AI platform for supply chain intelligence." },
